...
import { ClientStatis } from "@/lib/datastatis/clientstatis";

export default function Client() {
  return (
    <section className="py-5 ">
      <div className="">
        <h1 className="my-6 text-3xl min-md:text-4xl text-[#0C566D] font-bold text-pretty  text-center items-center-safe justify-center">
